...
cd $PYROBOT_REPO_PATH/robots/LoCoBot/install
...
echo "Dependencies pre-built complete, took $elapsed seconds in total"
echo "NOTE: Remember to logout and login back again before compiling through catkin_make or catkin build!"
